...
@section('content')
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="#" id = "off"><i class="fa fa-inbox"></i> Officials</a></li>
                <li><a href="{{URL::to('officialScheduleDay')}}" id = "day"><i class="fa fa-download"></i> Days</a></li>
                ...
                <div class="form-group">
                  ...
                  <select class = "form-control"
                    ...
                    @foreach($oDetails as $od)
                      <option value = "{{$od->OfficialID}}">{{$od -> LastName}}, {{$od -> FirstName}}</option>
                    @endforeach
                  </select>
                </div>
              </form>
      ...
      <div class="col-md-9">
        <div class="box box-warning">
          <div class="box-header with-border">
            <h3 class="box-title">Official Schedule Table</h3>
                    ...
                    <td>
                      <div class="">
                        ...
                        <label>{{$od->OfficialID}} {{$od->OfficialPosition}} - </label>
                          <h3 class="box-title"> {{$od -> FirstName}} {{$od -> LastName}} </h3>
                ...
                $('#example1').DataTable().row.add([
                  '<div class="">'+
                    '<div class="box-header with-border">'+
                      ...
                      '<h3 class="box-title">'+ val1.FirstName +' '+val1.LastName +'</h3>'+
